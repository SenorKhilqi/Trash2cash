        ...
        <div class="container py-5 mt-5">
            <div class="row justify-content-center">
                <div class="col-md-8 text-center text-white">
                    ...
                    <p class="lead">Mengenal lebih dekat dengan tim hebat yang berdedikasi untuk mengembangkan platform pengelolaan sampah digital</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <section class="team-grid">
        <div class="container">
            <div class="section-header" data-aos="fade-up">
                ...
                <p class="text-muted">Kami adalah mahasiswa Universitas Siliwangi jurusan Informatika yang berkolaborasi untuk menciptakan solusi pengelolaan sampah berkelanjutan</p>
            </div>
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                    <div class="team-member">
                        ...
                        <div class="member-info">
                            ...
                            <p class="member-desc">237006006 - Memimpin dan mengkoordinasikan seluruh aspek pengembangan platform Trash2Cash</p>
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                    <div class="team-member">
                        ...
                        <div class="member-info">
                            ...
                            <p class="member-desc">237006001 - Merancang antarmuka pengguna yang intuitif dan pengalaman pengguna yang optimal</p>
                            <div class="member-social">
                                <a href="#"><i class="fab fa-linkedin"></i></a>
                                <a href="#"><i class="fab fa-github"></i></a>
                                <a href="#"><i class="fab fa-instagram"></i></a>
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                    <div class="team-member">
                        ...
                        <div class="member-info">
                            ...
                            <p class="member-desc">237006008 - Menganalisis kebutuhan sistem dan merencanakan pengembangan platform</p>
                            <div class="member-social">
                                <a href="#"><i class="fab fa-linkedin"></i></a>
                                <a href="#"><i class="fab fa-github"></i></a>
                                <a href="#"><i class="fab fa-instagram"></i></a>
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
                    <div class="team-member">
                        ...
                        <div class="member-info">
                            ...
                            <p class="member-desc">237006022 - Mengembangkan antarmuka web responsif dan aplikasi mobile Trash2Cash</p>
                            <div class="member-social">
                                <a href="#"><i class="fab fa-linkedin"></i></a>
                                <a href="#"><i class="fab fa-github"></i></a>
                                <a href="#"><i class="fab fa-instagram"></i></a>
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="500">
                    <div class="team-member">
                        ...
                        <div class="member-info">
                            ...
                            <p class="member-desc">237006036 - Mengembangkan sistem backend dan database untuk platform Trash2Cash</p>
                            <div class="member-social">
                                <a href="#"><i class="fab fa-linkedin"></i></a>
                                <a href="#"><i class="fab fa-github"></i></a>
                                <a href="#"><i class="fab fa-instagram"></i></a>
